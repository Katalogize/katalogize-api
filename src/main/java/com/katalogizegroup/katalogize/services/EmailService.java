    ...
    private final String sharedKatalogHtml = """
            <div style='display: flex; place-content: center;'>
                <div style='width: max-content; margin: 50px; padding: 50px; border-radius: 10px; box-shadow: 0 1px 10px 0 rgb(0 0 0 / 10%), 0 2px 15px 0 rgb(0 0 0 / 5%);'>
                    ...
                    <div style='font-size: 21px; font-family: Inter,sans-serif;'>
                        <b>A Katalog was shared with you!</b>
                        <p>Hello, looks like someone shared the <b>KATALOG_NAME</b> Katalog with your e-mail!</p>
                        <p>Katalogize is a web application to catalog anything you need, however you want.</p>
                        <p>To view what was shared, visit Katalogize and log in to your account, or create a new account with this e-mail if you don't have one yet.</p>
                        <p style='text-align:center;  margin: 50px;'><a style="padding: 15px; border-radius: 10px; text-decoration: none; background-color: #279cac; color: white" href='https://katalogize.com' target='_blank' rel='noreferrer'>Visit Katalogize</a><p>
                        <p>If you have any questions, feel free to email us at: <a href='mailto:katalogize@gmail.com?subject=Katalogize Help Request' style='color: #279cac;'>katalogize@gmail.com</a></p>
                        <div>Thanks,</div>
                    <div style='color: #279cac;'><b>Katalogize Team</b></div></div>
                <div>
            </div>
            """;
    ...
    private final String changeUsernameHtml = """
            <div style='display: flex; place-content: center;'>
                <div style='width: max-content; margin: 50px; padding: 50px; border-radius: 10px; box-shadow: 0 1px 10px 0 rgb(0 0 0 / 10%), 0 2px 15px 0 rgb(0 0 0 / 5%);'>
                    ...
                    <div style='font-size: 21px; font-family: Inter,sans-serif;'>
                        <b>You requested an username change!</b>
                        <p>Hello, looks like you have requested a new username!</p>
                        <p>Your new username is <b>USER_NAME</b>. Don't forget to use it next time you log in to Katalogize.</p>
                        <p style='text-align:center;  margin: 50px;'><a style="padding: 15px; border-radius: 10px; text-decoration: none; background-color: #279cac; color: white" href='https://katalogize.com' target='_blank' rel='noreferrer'>Visit Katalogize</a><p>
                        <p>If you have any questions, feel free to email us at: <a href='mailto:katalogize@gmail.com?subject=Katalogize Help Request' style='color: #279cac;'>katalogize@gmail.com</a></p>
                        <div>Thanks,</div>
                    <div style='color: #279cac;'><b>Katalogize Team</b></div></div>
                    <p style='font-size: 14px;'>If you haven't requested an username change, please change you username on settings page and contact us.</p>
                <div>
            </div>
            """;
